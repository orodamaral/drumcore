...
3. Prever uma tela (TFT ST7735 1.8" 128x160, SPI, paisagem) e 1 encoder
   rotativo com chave (girar navega/ajusta valor, clicar desce um
...
biblioteca de terceiros vendorizada mantém o nome original.
